...
public class MetafixBindTest {
    ...
    @Test
    public void doListIndexedArrayNoChange() {
        MetafixTestHelpers.assertFix(streamReceiver, Arrays.asList(
                "do list('path': 'name[]', 'var': 'n')",
                " copy_field('n', 'author')",
                "end",
    ...
    @Test
    public void doListIndexedArrayToObjects() {
        MetafixTestHelpers.assertFix(streamReceiver, Arrays.asList(
                "do list('path': 'name[]', 'var': 'n')",
                " upcase('n')",
                " trim('n')",
    ...
    @Test
    @Disabled("Currently needs `transformFields` call, see test above and #102")
    public void doListIndexedArrayToObjectsNoChange() {
        MetafixTestHelpers.assertFix(streamReceiver, Arrays.asList(
                "do list('path': 'name[]', 'var': 'n')",
                " copy_field('n', 'author[].$append.name')",
                "end",
    ...
    @Test
    @Disabled("Currently needs `transformFields` call, see test above and #102")
    public void doListIndexedArrayOfObjectsNoChange() {
        MetafixTestHelpers.assertFix(streamReceiver, Arrays.asList(
                "do list('path': 'name[]', 'var': 'n')",
                " copy_field('n.name', 'author')",
                "end",
    ...
    @Test
    public void doListIndexedArrayOfObjectsToObjects() {
        MetafixTestHelpers.assertFix(streamReceiver, Arrays.asList(
                "do list('path': 'name[]', 'var': 'n')",
                " upcase('n')",
                " trim('n.name')",
    ...
    @Test
    @Disabled("Currently needs `transformFields` call, see test above and #102")
    public void doListIndexedArrayOfObjectsToObjectsNoChange() {
        MetafixTestHelpers.assertFix(streamReceiver, Arrays.asList(
                "do list('path': 'name[]', 'var': 'n')",
                " copy_field('n.name', 'author[].$append.name')",
                "end",
